...
open class DefaultCatalog : CatalogImpl("") {
    ...
    /**
     * The schema <code>central_outbox</code>.
     */
    val CENTRAL_OUTBOX: com.murray.outbox.infrastructure.`out`.persistence.jooq.codegen.CentralOutbox get(): com.murray.outbox.infrastructure.`out`.persistence.jooq.codegen.CentralOutbox = com.murray.outbox.infrastructure.`out`.persistence.jooq.codegen.CentralOutbox.CENTRAL_OUTBOX
